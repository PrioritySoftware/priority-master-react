...
(function () {
    ...
    function getExports($wnd) {
        ...
        // Start GWT code
var $intern_0 = {4:1, 8:1}, $intern_1 = {4:1, 6:1, 8:1}, $intern_2 = {4:1, 170:1}, $intern_3 = {7:1, 4:1, 6:1, 8:1}, $intern_4 = {4:1}, $intern_5 = 4194303, $intern_6 = 1048575, $intern_7 = 524288, $intern_8 = 4194304, $intern_9 = 17592186044416, $intern_10 = -9223372036854775808, $intern_11 = {45:1}, $intern_12 = {17:1}, $intern_13 = {4:1, 28:1, 63:1};
...
;
stringCastMap = {4:1, 198:1, 25:1, 2:1};
modernizeBrowser();
...
defineClass(85, 19, $intern_1);
var Lcom_google_gwt_core_client_impl_JavaScriptExceptionBase_2_classLit = createForClass('com.google.gwt.core.client.impl', 'JavaScriptExceptionBase', 85);
...
defineClass(24, 85, {24:1, 4:1, 6:1, 8:1}, JavaScriptException);
...
defineClass(114, 171, {}, SchedulerImpl);
var INSTANCE;
var Lcom_google_gwt_core_client_impl_SchedulerImpl_2_classLit = createForClass('com.google.gwt.core.client.impl', 'SchedulerImpl', 114);
...
defineClass(86, 182, {}, StackTraceCreator$CollectorLegacy);
...
;
var Lcom_google_gwt_core_client_impl_StackTraceCreator$CollectorLegacy_2_classLit = createForClass('com.google.gwt.core.client.impl', 'StackTraceCreator/CollectorLegacy', 86);
...
defineClass(87, 183, {}, StackTraceCreator$CollectorModernNoSourceMap);
_.createSte = function createSte_0(fileName, method, line, col){
  return new StackTraceElement(method, fileName, -1);
}
;
var Lcom_google_gwt_core_client_impl_StackTraceCreator$CollectorModernNoSourceMap_2_classLit = createForClass('com.google.gwt.core.client.impl', 'StackTraceCreator/CollectorModernNoSourceMap', 87);
...
_.isRepeating = false;
_.timerId = null;
var Lcom_google_gwt_user_client_Timer_2_classLit = createForClass('com.google.gwt.user.client', 'Timer', 160);
function Request$1(this$0){
  this.this$01 = this$0;
}

defineClass(161, 160, {}, Request$1);
var Lcom_google_gwt_http_client_Request$1_2_classLit = createForClass('com.google.gwt.http.client', 'Request/1', 161);
...
defineClass(95, 1, {}, RequestBuilder$1);
...
;
var Lcom_google_gwt_http_client_RequestBuilder$1_2_classLit = createForClass('com.google.gwt.http.client', 'RequestBuilder/1', 95);
...
defineClass(164, 7, $intern_3, RequestPermissionException);
...
defineClass(168, 7, $intern_3, RequestTimeoutException);
...
defineClass(159, 196, {}, ResponseImpl);
...
;
var Lcom_google_gwt_json_client_JSONValue_2_classLit = createForClass('com.google.gwt.json.client', 'JSONValue', 187);
...
defineClass(11, 187, {11:1}, JSONArray, JSONArray_0);
...
defineClass(75, 187, {}, JSONBoolean);
...
defineClass(61, 19, $intern_1, JSONException, JSONException_0);
var Lcom_google_gwt_json_client_JSONException_2_classLit = createForClass('com.google.gwt.json.client', 'JSONException', 61);
...
;
var instance;
var Lcom_google_gwt_json_client_JSONNull_2_classLit = createForClass('com.google.gwt.json.client', 'JSONNull', 167);
...
defineClass(27, 187, {27:1}, JSONNumber);
...
defineClass(5, 187, {5:1}, JSONObject, JSONObject_0);
...
defineClass(12, 187, {12:1}, JSONString);
_.equals$ = function equals_3(other){
  if (!instanceOf(other, 12)) {
    return false;
  }
  return $equals(this.value_0, dynamicCast(other, 12).value_0);
}
;
...
function fromInt(value_0){
  ...
  if (value_0 > -129 && value_0 < 128) {
    rebase = value_0 + 128;
    boxedValues == null && (boxedValues = initDim(Lcom_google_gwt_lang_LongLibBase$LongEmul_2_classLit, $intern_4, 202, 256, 0, 1));
...
defineClass(152, 43, {43:1}, ConsoleLogHandler);
...
;
var Lcom_google_gwt_logging_client_ConsoleLogHandler_2_classLit = createForClass('com.google.gwt.logging.client', 'ConsoleLogHandler', 152);
function DevelopmentModeLogHandler(){
  $setFormatter(this, new TextLogFormatter(false));
  $setLevel(this, ($clinit_Level() , ALL));
}

defineClass(153, 43, {43:1}, DevelopmentModeLogHandler);
_.publish = function publish_0(record){
  return;
}
;
var Lcom_google_gwt_logging_client_DevelopmentModeLogHandler_2_classLit = createForClass('com.google.gwt.logging.client', 'DevelopmentModeLogHandler', 153);
...
defineClass(194, 1, {});
var Ljava_util_logging_Formatter_2_classLit = createForClass('java.util.logging', 'Formatter', 194);
defineClass(195, 194, {});
var Lcom_google_gwt_logging_impl_FormatterImpl_2_classLit = createForClass('com.google.gwt.logging.impl', 'FormatterImpl', 195);
...
defineClass(73, 195, {}, TextLogFormatter);
...
defineClass(190, 1, {});
var Ljava_io_OutputStream_2_classLit = createForClass('java.io', 'OutputStream', 190);
defineClass(191, 190, {});
var Ljava_io_FilterOutputStream_2_classLit = createForClass('java.io', 'FilterOutputStream', 191);
defineClass(192, 191, {});
var Ljava_io_PrintStream_2_classLit = createForClass('java.io', 'PrintStream', 192);
function StackTracePrintStream(builder){
  this.builder = builder;
}

defineClass(155, 192, {}, StackTracePrintStream);
var Lcom_google_gwt_logging_impl_StackTracePrintStream_2_classLit = createForClass('com.google.gwt.logging.impl', 'StackTracePrintStream', 155);
...
function getJSONStringProperty(obj, propertyName){
  $clinit_PriCommon();
  var js;
  js = dynamicCast($get_0(obj, propertyName), 12);
  if (!js)
    return '';
  return js.value_0;
}
...
var APIVersion = '1.8.6', AppMain, BuildVersion = 0, MajorVersion = 0, MinorVersion = 0, SystemImagesDir = '', SystemMailDir = '', isDebugging = true, logger_0;
...
;
var Lcom_priority_app_common_WCFResponse_2_classLit = createForClass('com.priority.app.common', 'WCFResponse', 10);
...
function $FormStartExMobAsync(this$static, form_0, appParams, callback){
  var data_0;
  if (!!this$static.conHolder && !this$static.conHolder.SetIsGoneToServer(callback)) {
...
function $FormSubFormExMobAsync(this$static, statexml, self_0, appParams, callback){
  ...
  $setHeader(this$static, 'SOAPAction', 'http://tempuri.org/IWCFService/' + this$static.curop);
  data_0 = '<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/"><s:Header><Language xmlns="PriorityNS">' + ('' + this$static.Userlang) + '<\/Language><Hostname xmlns="PriorityNS">' + (this$static.Compname == null?'':this$static.Compname) + '<\/Hostname><WinUser xmlns="PriorityNS">' + (this$static.WindowsUser == null?'':this$static.WindowsUser) + '<\/WinUser><UtcOffset xmlns="PriorityNS">' + JSGetTimeAndPlace() + '<\/UtcOffset><Environment xmlns="PriorityNS">' + (!!this$static.conHolder && this$static.conHolder.getDname() != null?this$static.conHolder.getDname():this$static.Dname == null?'':this$static.Dname) + '<\/Environment><SilverLight xmlns="PriorityNS">2' + '<\/SilverLight>' + ('<OtherInfo xmlns="PriorityNS">app_' + AppName + ',<\/OtherInfo>') + '<Security s:mustUnderstand="1" xmlns:u="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd" xmlns="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd"> <u:Timestamp u:Id="_0">' + GMTDates() + '<\/u:Timestamp> <UsernameToken><Username>' + this$static.Username + '<\/Username><Password Type="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordText">' + this$static.Password + '<\/Password><\/UsernameToken><\/Security><\/s:Header><s:Body><' + this$static.curop + ' xmlns="http://tempuri.org/">' + $OneParameter_0('statexml', statexml) + ('<self>' + ('' + toString_9(self_0)) + '<\/' + 'self' + '>') + $OneParameter('empty', ($clinit_Boolean() , $clinit_Boolean() , FALSE_0)) + $OneParameter_0('appParams', appParams) + ('<\/' + this$static.curop + '><\/s:Body><\/s:Envelope>');
  try {
    throwIfNull('callback', callback);
    $doSend(this$static, data_0, callback);
  }
...
function $SetUsernamePassword(this$static, app, username, password, isActiveDirectory){
  this$static.Username = username + '\t' + app;
  isActiveDirectory && (this$static.Username = '$AppAd$' + this$static.Username);
...
defineClass(94, 66, {}, WCFService);
_.Userlang = 0;
var Lcom_priority_app_common_WCFService_2_classLit = createForClass('com.priority.app.common', 'WCFService', 94);
function GetWCFServiceClient(conHolder){
  var con;
  con = new WCFService(Host, conHolder);
  $SetUsernamePassword(con, App, Login, Pwd, IsActiveDirectory);
...
function SetWCFServiceParams(host, app, lang_0, dname, appname, isActiveDirectory){
  Host = host;
  App = app;
  Lang = lang_0;
  DName = dname;
...
var App, AppName, ComputerName, DName, Host, IsActiveDirectory = false, Lang = 0, Login, Pwd, WindowsUser;
...
defineClass(169, 1, {}, DirectAct);
var Lcom_priority_app_form_DirectAct_2_classLit = createForClass('com.priority.app.form', 'DirectAct', 169);
function $Activate(this$static, start_0, onSuccess, onError, ename, type_0, onProgress){
  ...
  $FormActivateMobAsync($GetConnection(this$static), b64encode($ToStringData(this$static._currentFormState, this$static.privateSession, memento)), start_0, new Form$10(this$static, $GetConnection(this$static), this$static, start_0, ename, type_0, onProgress, onSuccess, onError));
}
...
function $ActivateStart(this$static, onSuccess, onError, ename, type_0, onProgress, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , ActivateStart_0), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [onSuccess, onError, ename, type_0, onProgress])), executeNow))
    return;
...
function $AddText(this$static, text_0, addFlag, commentFlag, lang2Flag, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , AddText_0), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [text_0, valueOf(addFlag), valueOf(commentFlag), valueOf(lang2Flag), onSuccess, onError])), executeNow))
    return;
  memento = $CreateMemento(this$static.curTab);
  error = null;
  errorType = null;
...
function $ClearRows(this$static, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , ClearRows_0), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [onSuccess, onError])), executeNow))
    return;
...
function $ClearSearchFilter(this$static, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , ClearSearchFilter_0), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [onSuccess, onError])), executeNow))
    return;
...
function $DelRow(this$static, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , DelRow_0), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [onSuccess, onError])), executeNow))
    return;
...
function $EndCurrentForm(this$static, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , EndCurrentForm_0), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [onSuccess, onError])), executeNow))
    return;
  if ($InvokeErrorIfRowChanged(this$static, onSuccess, onError))
    return;
  if (this$static.curTab.ishtml_0 == 1 && this$static.curTab.isEdit == 1) {
    ...
    memento = $CreateMemento(this$static.curTab);
    $FormExitFormMobAsync($GetConnection(this$static), b64encode($ToStringData(this$static._currentFormState, this$static.privateSession, memento)), new Form$12($GetConnection(this$static), this$static, onSuccess, onError));
  }
   else {
...
function $FormChoose(this$static, fieldName, fieldValue, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , Choose_0), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [fieldName, fieldValue, onSuccess, onError])), executeNow))
    return;
  ...
  memento = $CreateMemento(this$static.curTab);
  $FormKeyMobAsync($GetConnection(this$static), b64encode($ToStringData(this$static._currentFormState, this$static.privateSession, memento)), fromInt(($clinit_PriCommon$ChooseTypes() , Normal).intValue), new Form$19($GetConnection(this$static), this$static, onSuccess, onError));
}
...
function $FormFieldUpdate(this$static, fieldName, value_0, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , FieldUpdate), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [fieldName, value_0, onSuccess, onError])), executeNow))
    return;
  col = $getCol(this$static.curTab, fieldName);
  if (!col) {
...
function $FormSearchAction(this$static, action, searchText, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , SearchAction), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [valueOf(action), searchText, onSuccess, onError])), executeNow))
    return;
  $FormSearchMobAsync($GetConnection(this$static), ($InitDummyFormState(this$static) , this$static.dummyFormState), fromInt(action), searchText, new Form$18($GetConnection(this$static), this$static, onSuccess, onError));
}

function $FormStart(this$static, name_0, autoRetrieveFirstRows, onSuccess, onError, params){
  var appParams, hiddenFields, rsp;
  ...
  $clinit_PriCommon();
  if (3 <= BuildVersion && hiddenFields != null && hiddenFields.length > 0) {
    appParams = (autoRetrieveFirstRows?'1':'0') + '@P@' + hiddenFields;
    $FormStartExMobAsync($GetConnection(this$static), name_0, appParams, rsp);
  }
   else {
    $FormStartMobAsync($GetConnection(this$static), name_0, autoRetrieveFirstRows, rsp);
  }
}
...
function $FormWarning(this$static, ok, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , WarningApproved), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [valueOf(ok), onError])), executeNow))
    return;
...
function $GetRows(this$static, fromRow, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , GetRows_0), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [valueOf(fromRow), onSuccess, onError])), executeNow))
    return;
  if ($InvokeErrorIfRowChanged(this$static, onSuccess, onError))
    return;
...
function $GotoSubForm(this$static, formName, onMessageFunc, onUpdateFieldsFunc, onSuccess, onError, executeNow, params){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , StartSubForm), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [formName, onMessageFunc, onUpdateFieldsFunc, onSuccess, onError, params])), executeNow))
    return;
  if ($InvokeErrorIfRowChanged(this$static, onSuccess, onError))
    return;
  ...
  3 <= BuildVersion && hiddenFields != null && hiddenFields.length > 0?$FormSubFormExMobAsync($GetConnection(this$static), b64encode($ToStringData(this$static._currentFormState, this$static.privateSession, memento)), fromInt(dynamicCast($getStringValue(ft.SubForms, formName), 52).self_0), hiddenFields, rsp):$FormSubFormMobAsync($GetConnection(this$static), b64encode($ToStringData(this$static._currentFormState, this$static.privateSession, memento)), fromInt(dynamicCast($getStringValue(ft.SubForms, formName), 52).self_0), rsp);
}
...
function $IsAlive(this$static, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , IsAlive_0), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [onSuccess, onError])), executeNow))
    return;
  memento = $CreateMemento(this$static.curTab);
  $FormIsAliveMobAsync($GetConnection(this$static), b64encode($ToStringData(this$static._currentFormState, this$static.privateSession, memento)), new Form$16($GetConnection(this$static), this$static, onSuccess, onError));
}
...
function $NewRow(this$static, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , NewRow_0), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [onSuccess, onError])), executeNow))
    return;
  if ($InvokeErrorIfRowChanged(this$static, onSuccess, onError))
    return;
...
function $SaveCurrentRow(this$static, exit, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , SaveRow), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [valueOf(exit), onSuccess, onError])), executeNow))
    return;
  memento = $CreateMemento(this$static.curTab);
...
function $SetActiveRow(this$static, row, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , SetActiveRow_0), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [valueOf(row), onSuccess, onError])), executeNow))
    return;
...
function $SetSearchFilter(this$static, filter, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , SetSearchFilter_0), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [filter, onSuccess, onError])), executeNow))
    return;
...
function $SetSimpleSearchFilter(this$static, filter, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , SetSimpleSearchFilter_0), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [filter, onSuccess, onError])), executeNow))
    return;
...
function $Undo(this$static, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , Undo_0), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [onSuccess, onError])), executeNow))
    return;
...
function $UploadFile(this$static, uploadFileSection, fileName, fileContents, onSuccess, onError, userState){
  ...
  memento = $CreateMemento(this$static.curTab);
  finished?$FormUploadFileAsyncMob($GetConnection(this$static), b64encode($ToStringData(this$static._currentFormState, this$static.privateSession, memento)), {l:2, m:0, h:0}, fileName, b64encode(''), new Form$9(this$static, $GetConnection(this$static), this$static, fileName, userState, uploadFileSection, fileContents, onSuccess, onError)):$FormUploadFileAsyncMob($GetConnection(this$static), b64encode($ToStringData(this$static._currentFormState, this$static.privateSession, memento)), fromInt(uploadmode), fileName, b64encode(macFileTransfer), new Form$8(this$static, $GetConnection(this$static), this$static, fileName, userState, uploadFileSection, fileContents, onSuccess, onError));
}
...
function $UploadFile_0(this$static, file, onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this$static.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , UploadFile_1), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [file, onSuccess, onError])), executeNow))
    return;
  if (!file) {
  ...
  $FormSearchSetDirtyMobAsync($GetConnection(this$static), ($InitDummyFormState(this$static) , this$static.dummyFormState), new Form$6($GetConnection(this$static), this$static, file, onSuccess, onError));
}
    ...
    for (var i = 0; i < jo.Form[0].NewTable.length; i++) {
      ...
      if (maintable.NewColumn && maintable.NewColumn.length > 0) {
        for (var j = 0; j < maintable.NewColumn.length; j++) {
          ...
          that.AddColumn(self_0, zoomname, typestr, width_0, field, hidden);
          if (gform != null) {
...
_.ActivateEnd = function ActivateEnd(onSuccess, onError, executeNow){
  ...
  if (!$CanExecuteNow(this.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , ActivateEnd_0), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [onSuccess, onError])), executeNow))
    return;
...
;
_.AddColumn = function AddColumn(form_0, name_0, type_0, width_0, field, hidden){
  var ft, fc;
  ft = dynamicCast($get_1(this.FormTables, valueOf(form_0)), 21);
  !!ft && (fc = new FormColumn(name_0, type_0, width_0, field, hidden) , $putStringValue(ft.FormColumns, name_0, fc) , $put_0(ft.FormColumnsI, valueOf(field), fc) , undefined);
}
;
...
_.UploadDataUrl = function UploadDataUrl(dataUrl, type_0, onSuccess, onError, executeNow){
  ...
  $clinit_PriCommon();
  isDebugging && $log_1(logger_0, ($clinit_Level() , ALL), 'In UploadFile: executeNow=' + executeNow);
  if (!$CanExecuteNow(this.RequestsQueue, new FormAPIRequest(($clinit_FormAPIRequest$RequestTypes() , UploadFile_1), initValues(getClassLiteralForArray(Ljava_lang_Object_2_classLit, 1), $intern_4, 1, 3, [dataUrl, type_0, onSuccess, onError])), executeNow))
    return;
  if (dataUrl == '') {
  ...
  that = this;
  $FormSearchSetDirtyMobAsync($GetConnection(this), ($InitDummyFormState(this) , this.dummyFormState), new Form$7($GetConnection(this), that, type_0, dataUrl, onSuccess, onError));
}
;
...
var isLastOperationDel_0 = false, lastOperation;
var Lcom_priority_app_form_Form_2_classLit = createForClass('com.priority.app.form', 'Form', 124);
...
;
var Lcom_priority_app_form_Form$1_2_classLit = createForClass('com.priority.app.form', 'Form/1', 127);
function Form$10(this$0, $anonymous0, val$thisForm, val$start, val$ename, val$type, val$onProgress, val$onSuccess, val$onError){
  this.this$01 = this$0;
  this.val$thisForm3 = val$thisForm;
...
;
_.val$start4 = false;
var Lcom_priority_app_form_Form$10_2_classLit = createForClass('com.priority.app.form', 'Form/10', 136);
...
;
var Lcom_priority_app_form_Form$11_2_classLit = createForClass('com.priority.app.form', 'Form/11', 137);
...
function Form$12($anonymous0, val$thisForm, val$onSuccess, val$onError){
  this.val$thisForm3 = val$thisForm;
  this.val$onSuccess4 = val$onSuccess;
  this.val$onError5 = val$onError;
  WCFResponse.call(this, $anonymous0);
...
;
var Lcom_priority_app_form_Form$12_2_classLit = createForClass('com.priority.app.form', 'Form/12', 138);
...
_.val$row5 = 0;
var Lcom_priority_app_form_Form$13_2_classLit = createForClass('com.priority.app.form', 'Form/13', 139);
...
;
var Lcom_priority_app_form_Form$14_2_classLit = createForClass('com.priority.app.form', 'Form/14', 140);
...
;
var Lcom_priority_app_form_Form$15_2_classLit = createForClass('com.priority.app.form', 'Form/15', 141);
...
;
var Lcom_priority_app_form_Form$16_2_classLit = createForClass('com.priority.app.form', 'Form/16', 142);
function Form$17(this$0, $anonymous0, val$thisForm, val$onSuccess, val$onError){
  this.this$01 = this$0;
  this.val$thisForm3 = val$thisForm;
  this.val$onSuccess4 = val$onSuccess;
  this.val$onError5 = val$onError;
...
;
var Lcom_priority_app_form_Form$17_2_classLit = createForClass('com.priority.app.form', 'Form/17', 143);
...
;
var Lcom_priority_app_form_Form$18_2_classLit = createForClass('com.priority.app.form', 'Form/18', 144);
...
;
var Lcom_priority_app_form_Form$19_2_classLit = createForClass('com.priority.app.form', 'Form/19', 145);
...
;
var Lcom_priority_app_form_Form$2_2_classLit = createForClass('com.priority.app.form', 'Form/2', 128);
...
;
_.val$fromRow6 = 0;
var Lcom_priority_app_form_Form$3_2_classLit = createForClass('com.priority.app.form', 'Form/3', 129);
...
;
_.val$fromRow6 = 0;
var Lcom_priority_app_form_Form$4_2_classLit = createForClass('com.priority.app.form', 'Form/4', 130);
...
;
var Lcom_priority_app_form_Form$5_2_classLit = createForClass('com.priority.app.form', 'Form/5', 131);
function Form$6($anonymous0, val$that, val$file, val$onSuccess, val$onError){
...
;
var Lcom_priority_app_form_Form$6_2_classLit = createForClass('com.priority.app.form', 'Form/6', 132);
function Form$7($anonymous0, val$that, val$type, val$dataUrl, val$onSuccess, val$onError){
  this.val$that3 = val$that;
...
;
var Lcom_priority_app_form_Form$7_2_classLit = createForClass('com.priority.app.form', 'Form/7', 133);
...
var Lcom_priority_app_form_Form$8_2_classLit = createForClass('com.priority.app.form', 'Form/8', 134);
function Form$9(this$0, $anonymous0, val$thisForm, val$fileName, val$userState, val$uploadFileSection, val$contents, val$onSuccess, val$onError){
  this.this$01 = this$0;
  this.val$thisForm3 = val$thisForm;
  this.val$fileName4 = val$fileName;
  this.val$userState5 = val$userState;
...
;
_.val$uploadFileSection6 = 0;
var Lcom_priority_app_form_Form$9_2_classLit = createForClass('com.priority.app.form', 'Form/9', 135);
function Form$Position(){
}

defineClass(125, 1, {}, Form$Position);
_.changed_0 = 0;
_.field_0 = 0;
_.isappend_0 = 0;
_.line_0 = 0;
_.table_0 = 0;
var Lcom_priority_app_form_Form$Position_2_classLit = createForClass('com.priority.app.form', 'Form/Position', 125);
...
defineClass(126, 1, {}, Form$WarningMessageData);
_.readWrite = 0;
_.wkey = {l:0, m:0, h:0};
_.wline = {l:0, m:0, h:0};
_.wstep = {l:0, m:0, h:0};
_.wval = {l:0, m:0, h:0};
var Lcom_priority_app_form_Form$WarningMessageData_2_classLit = createForClass('com.priority.app.form', 'Form/WarningMessageData', 126);
function FormStart(name_0, onShowMessageFunc, updateFieldsFunc, onSuccess, onError, autoRetrieveFirstRows, dn, params){
  ...
  $FormStart(f, name_0, autoRetrieveFirstRows == 1, onSuccess, onError, params);
}
...
defineClass(156, 1, {}, FormAPIQueue);
_.isExecutingNow = false;
_.isWaitingForWarningApprove = false;
var Lcom_priority_app_form_FormAPIQueue_2_classLit = createForClass('com.priority.app.form', 'FormAPIQueue', 156);
...
function FormColumn(zoomname, type_0, width_0, field, hidden){
  this.field_0 = field;
...
function $ComposeText(this$static, curText, textToAdd, addFlag, addSignature, lang2){
  ...
  if (addSignature) {
    ...
    end += ($clinit_PriCommon() , '<p dir=' + (Lang == 1 && !lang2?'rtl':'ltr') + '>' + '&nbsp;' + '<\/p>\n' + $pGet('<!--psi-->' + sig.message_0, lang2) + $pGet(sig.name_0, lang2) + $pGet(sig.position_0, lang2) + $pGet(sig.email_0, lang2) + $pGet(sig.phone_0, lang2) + $pGet(sig.cellphone_0, lang2) + $pGet(sig.dept_0, lang2) + $pGet(sig.branch_0, lang2) + $pGet(sig.company_0 + '<!--esi-->', lang2));
  }
...
defineClass(157, 1, {}, FormTableOperations);
var Lcom_priority_app_form_FormTableOperations_2_classLit = createForClass('com.priority.app.form', 'FormTableOperations', 157);
...
defineClass(52, 1, {52:1}, SubForm);
_.self_0 = 0;
var Lcom_priority_app_form_SubForm_2_classLit = createForClass('com.priority.app.form', 'SubForm', 52);
...
_.Companies = function Companies(onSuccess, onError){
  var con;
  $clinit_PriCommon();
  1 <= BuildVersion || InvokeError_0('This feature is supported from web-sdk patch version 1', onError, 'notSupportedInThisPriorityVersion', 'apiError');
  con = (this.con = GetWCFServiceClient(this) , this.con);
  $GeneralCompaniesMobAsync(con, new PriorityApp$3(con, onSuccess, onError));
}
;
_.Constants = function Constants(onSuccess, onError){
  cachedConstants?InvokeSuccess_0(cachedConstants.jsObject, onSuccess):InvokeError_0('Constants initilization failed', onError, 'constantsUninitialized', 'apiError');
}
;
_.EntMessages = function EntMessages(ename, type_0, from, to, onSuccess, onError){
  ...
  1 <= BuildVersion || InvokeError_0('This feature is supported from web-sdk patch version 1', onError, 'notSupportedInThisPriorityVersion', 'apiError');
  con = (this.con = GetWCFServiceClient(this) , this.con);
  $GeneralExtMessagesRangeMobAsync(con, ename, type_0, fromInt(from), fromInt(to), new PriorityApp$4(this, con, onSuccess, onError));
}
;
...
_.Languages = function Languages(onSuccess, onError){
  var con;
  $clinit_PriCommon();
  2 <= BuildVersion || InvokeError_0('This feature is supported from web-sdk patch version 2', onError, 'notSupportedInThisPriorityVersion', 'apiError');
  con = (this.con = GetWCFServiceClient(this) , this.con);
  $GeneralLanguagesMobAsync(con, new PriorityApp$2(con, onSuccess, onError));
}
;
_.Login = function Login_0(configuration, onSuccess, onError){
  var conf;
  conf = configuration;
  SetWCFServiceParams(conf.url + '/wcf/wcf/Service.svc', conf.tabulaini, conf.language, conf.company, conf.appname, conf.activeDirectory == 1);
...
defineClass(81, 10, {}, PriorityApp$1);
...
defineClass(82, 10, {}, PriorityApp$2);
...
defineClass(83, 10, {}, PriorityApp$3);
...
function PriorityApp$4(this$0, $anonymous0, val$onSuccess, val$onError){
  this.this$01 = this$0;
  this.val$onSuccess3 = val$onSuccess;
  this.val$onError4 = val$onError;
  WCFResponse.call(this, $anonymous0);
...
defineClass(84, 10, {}, PriorityApp$4);
...
;
var Lcom_priority_app_main_PriorityApp$4_2_classLit = createForClass('com.priority.app.main', 'PriorityApp/4', 84);
...
function $NewReport(this$static, proc, onSuccess, onError){
  ...
  str = dynamicCast($get_0(proc, 'optionselected'), 12);
  option = null;
...
function $ProcMessage(this$static, curmsg, onSuccess){
  var msgtext, mt;
  mt = dynamicCast($get_0(curmsg, 'messagetype'), 12);
...
function $ProcStep(this$static, jo, operation, newStep, onSuccess, onError){
  ...
  step = dynamicCast($get_0(proc, 'step'), 12).value_0;
  this$static.lastOperation = operation;
  newStep && (this$static.MsgCounter = 0);
  s = dynamicCast($get_0(proc, 'session'), 12);
...
_.OpenChoose = function OpenChoose(fieldId, value_0, data_0, onSuccess, onError){
  var field, json, proc;
  field = dynamicCast($get_1(this.inputFields_0, valueOf(fieldId)), 57);
  proc = this;
  if (!field) {
...
;
var Lcom_priority_app_proc_Proc$1_2_classLit = createForClass('com.priority.app.proc', 'Proc/1', 146);
...
;
var Lcom_priority_app_proc_Proc$2_2_classLit = createForClass('com.priority.app.proc', 'Proc/2', 147);
...
;
var Lcom_priority_app_proc_Proc$3_2_classLit = createForClass('com.priority.app.proc', 'Proc/3', 148);
...
;
_.val$fieldId5 = 0;
var Lcom_priority_app_proc_Proc$4_2_classLit = createForClass('com.priority.app.proc', 'Proc/4', 149);
...
;
var Lcom_priority_app_proc_Proc$4$1_2_classLit = createForClass('com.priority.app.proc', 'Proc/4/1', 150);
...
defineClass(151, 1, {}, Proc$5);
var Lcom_priority_app_proc_Proc$5_2_classLit = createForClass('com.priority.app.proc', 'Proc/5', 151);
...
defineClass(26, 10, {}, Proc$CommonResponse);
...
defineClass(57, 1, {57:1}, Proc$InputField);
var Lcom_priority_app_proc_Proc$InputField_2_classLit = createForClass('com.priority.app.proc', 'Proc/InputField', 57);
function $OnPriError_4(this$static){
...
defineClass(50, 10, {}, Proc$WaitProcessResponse);
...
defineClass(93, 19, $intern_1, ArithmeticException);
var Ljava_lang_ArithmeticException_2_classLit = createForClass('java.lang', 'ArithmeticException', 93);
...
defineClass(165, 19, $intern_1, IllegalStateException);
var Ljava_lang_IllegalStateException_2_classLit = createForClass('java.lang', 'IllegalStateException', 165);
function IndexOutOfBoundsException(message){
  RuntimeException_0.call(this, message);
}

defineClass(58, 19, $intern_1, IndexOutOfBoundsException);
...
defineClass(23, 55, {4:1, 25:1, 23:1, 55:1}, Integer);
...
defineClass(32, 65, {198:1}, StringBuilder, StringBuilder_0);
...
;
_.size_0 = 0;
var Ljava_util_AbstractHashMap_2_classLit = createForClass('java.util', 'AbstractHashMap', 88);
defineClass(186, 185, $intern_11);
...
defineClass(33, 186, $intern_11, AbstractHashMap$EntrySet);
...
;
var Ljava_util_AbstractList_2_classLit = createForClass('java.util', 'AbstractList', 188);
...
defineClass(91, 186, $intern_11, AbstractMap$1);
...
;
var Ljava_util_AbstractMap$1_2_classLit = createForClass('java.util', 'AbstractMap/1', 91);
...
defineClass(92, 1, {}, AbstractMap$1$1);
...
;
var Ljava_util_AbstractMap$1$1_2_classLit = createForClass('java.util', 'AbstractMap/1/1', 92);
defineClass(89, 1, $intern_12);
...
;
var Ljava_util_AbstractMap$AbstractEntry_2_classLit = createForClass('java.util', 'AbstractMap/AbstractEntry', 89);
function AbstractMap$SimpleEntry(key, value_0){
  this.key = key;
  this.value_0 = value_0;
}

defineClass(90, 89, $intern_12, AbstractMap$SimpleEntry);
var Ljava_util_AbstractMap$SimpleEntry_2_classLit = createForClass('java.util', 'AbstractMap/SimpleEntry', 90);
defineClass(189, 1, $intern_12);
...
;
var Ljava_util_AbstractMapEntry_2_classLit = createForClass('java.util', 'AbstractMapEntry', 189);
defineClass(197, 188, {28:1});
...
;
var Ljava_util_AbstractSequentialList_2_classLit = createForClass('java.util', 'AbstractSequentialList', 197);
...
defineClass(38, 188, $intern_13, ArrayList);
...
defineClass(101, 1, {}, Collections$UnmodifiableCollectionIterator);
...
;
var Ljava_util_Collections$UnmodifiableCollectionIterator_2_classLit = createForClass('java.util', 'Collections/UnmodifiableCollectionIterator', 101);
...
defineClass(96, 1, {53:1}, Collections$UnmodifiableMap);
...
;
var Ljava_util_Collections$UnmodifiableMap_2_classLit = createForClass('java.util', 'Collections/UnmodifiableMap', 96);
defineClass(97, 67, $intern_11);
...
;
var Ljava_util_Collections$UnmodifiableSet_2_classLit = createForClass('java.util', 'Collections/UnmodifiableSet', 97);
function Collections$UnmodifiableMap$UnmodifiableEntrySet(s){
  Collections$UnmodifiableCollection.call(this, s);
}

defineClass(98, 97, $intern_11, Collections$UnmodifiableMap$UnmodifiableEntrySet);
...
;
var Ljava_util_Collections$UnmodifiableMap$UnmodifiableEntrySet_2_classLit = createForClass('java.util', 'Collections/UnmodifiableMap/UnmodifiableEntrySet', 98);
function Collections$UnmodifiableMap$UnmodifiableEntrySet$1(val$it){
  this.val$it2 = val$it;
}

defineClass(102, 1, {}, Collections$UnmodifiableMap$UnmodifiableEntrySet$1);
...
;
var Ljava_util_Collections$UnmodifiableMap$UnmodifiableEntrySet$1_2_classLit = createForClass('java.util', 'Collections/UnmodifiableMap/UnmodifiableEntrySet/1', 102);
function Collections$UnmodifiableMap$UnmodifiableEntrySet$UnmodifiableEntry(entry){
  this.entry = entry;
}

defineClass(99, 1, $intern_12, Collections$UnmodifiableMap$UnmodifiableEntrySet$UnmodifiableEntry);
...
;
var Ljava_util_Collections$UnmodifiableMap$UnmodifiableEntrySet$UnmodifiableEntry_2_classLit = createForClass('java.util', 'Collections/UnmodifiableMap/UnmodifiableEntrySet/UnmodifiableEntry', 99);
function Collections$UnmodifiableRandomAccessList(list){
  Collections$UnmodifiableList.call(this, list);
}

defineClass(100, 68, {28:1, 63:1}, Collections$UnmodifiableRandomAccessList);
var Ljava_util_Collections$UnmodifiableRandomAccessList_2_classLit = createForClass('java.util', 'Collections/UnmodifiableRandomAccessList', 100);
...
defineClass(166, 19, $intern_1, ConcurrentModificationException);
...
defineClass(9, 88, {4:1, 53:1}, HashMap);
...
defineClass(113, 1, {}, InternalJsHashCodeMap$1);
...
_.itemIndex = 0;
_.lastEntry = null;
var Ljava_util_InternalJsHashCodeMap$1_2_classLit = createForClass('java.util', 'InternalJsHashCodeMap/1', 113);
function InternalJsHashCodeMap$InternalJsHashCodeMapLegacy(){
  InternalJsHashCodeMap.call(this);
}

defineClass(111, 71, {}, InternalJsHashCodeMap$InternalJsHashCodeMapLegacy);
...
;
var Ljava_util_InternalJsHashCodeMap$InternalJsHashCodeMapLegacy_2_classLit = createForClass('java.util', 'InternalJsHashCodeMap/InternalJsHashCodeMapLegacy', 111);
function InternalJsHashCodeMap$InternalJsHashCodeMapLegacy$1(this$1){
  this.this$11 = this$1;
  ArrayList.call(this);
}

defineClass(112, 38, $intern_13, InternalJsHashCodeMap$InternalJsHashCodeMapLegacy$1);
...
;
var Ljava_util_InternalJsHashCodeMap$InternalJsHashCodeMapLegacy$1_2_classLit = createForClass('java.util', 'InternalJsHashCodeMap/InternalJsHashCodeMapLegacy/1', 112);
function InternalJsMapFactory(){
}

defineClass(108, 1, {}, InternalJsMapFactory);
...
;
var Ljava_util_InternalJsMapFactory_2_classLit = createForClass('java.util', 'InternalJsMapFactory', 108);
...
defineClass(110, 108, {}, InternalJsMapFactory$KeysWorkaroundJsMapFactory);
_.createJsStringMap = function createJsStringMap_0(){
  return new InternalJsStringMap$InternalJsStringMapWithKeysWorkaround;
}
;
var Ljava_util_InternalJsMapFactory$KeysWorkaroundJsMapFactory_2_classLit = createForClass('java.util', 'InternalJsMapFactory/KeysWorkaroundJsMapFactory', 110);
function InternalJsMapFactory$LegacyInternalJsMapFactory(){
}

defineClass(109, 108, {}, InternalJsMapFactory$LegacyInternalJsMapFactory);
...
;
var Ljava_util_InternalJsMapFactory$LegacyInternalJsMapFactory_2_classLit = createForClass('java.util', 'InternalJsMapFactory/LegacyInternalJsMapFactory', 109);
...
defineClass(70, 189, $intern_12, InternalJsStringMap$2);
...
defineClass(103, 56, {}, InternalJsStringMap$InternalJsStringMapLegacy);
...
defineClass(105, 38, $intern_13, InternalJsStringMap$InternalJsStringMapLegacy$1);
...
defineClass(104, 56, {}, InternalJsStringMap$InternalJsStringMapWithKeysWorkaround);
...
defineClass(162, 197, {4:1, 28:1}, LinkedList);
...
defineClass(163, 1, {}, LinkedList$ListIteratorImpl);
...
_.currentIndex = 0;
_.lastNode = null;
var Ljava_util_LinkedList$ListIteratorImpl_2_classLit = createForClass('java.util', 'LinkedList/ListIteratorImpl', 163);
function LinkedList$Node(){
}

defineClass(59, 1, {}, LinkedList$Node);
var Ljava_util_LinkedList$Node_2_classLit = createForClass('java.util', 'LinkedList/Node', 59);
var Ljava_util_Map$Entry_2_classLit = createForInterface('java.util', 'Map/Entry');
function NoSuchElementException(){
  RuntimeException.call(this);
}

defineClass(60, 19, {4:1, 6:1, 8:1, 60:1}, NoSuchElementException);
var Ljava_util_NoSuchElementException_2_classLit = createForClass('java.util', 'NoSuchElementException', 60);
...
var Ljava_util_logging_Level_2_classLit = createForClass('java.util.logging', 'Level', 193);
function Level$LevelAll(){
}

defineClass(115, 193, $intern_4, Level$LevelAll);
...
;
var Ljava_util_logging_Level$LevelAll_2_classLit = createForClass('java.util.logging', 'Level/LevelAll', 115);
function Level$LevelConfig(){
}

defineClass(116, 193, $intern_4, Level$LevelConfig);
...
;
var Ljava_util_logging_Level$LevelConfig_2_classLit = createForClass('java.util.logging', 'Level/LevelConfig', 116);
function Level$LevelFine(){
}

defineClass(117, 193, $intern_4, Level$LevelFine);
...
;
var Ljava_util_logging_Level$LevelFine_2_classLit = createForClass('java.util.logging', 'Level/LevelFine', 117);
function Level$LevelFiner(){
}

defineClass(118, 193, $intern_4, Level$LevelFiner);
...
;
var Ljava_util_logging_Level$LevelFiner_2_classLit = createForClass('java.util.logging', 'Level/LevelFiner', 118);
function Level$LevelFinest(){
}

defineClass(119, 193, $intern_4, Level$LevelFinest);
...
;
var Ljava_util_logging_Level$LevelFinest_2_classLit = createForClass('java.util.logging', 'Level/LevelFinest', 119);
function Level$LevelInfo(){
}

defineClass(120, 193, $intern_4, Level$LevelInfo);
...
;
var Ljava_util_logging_Level$LevelInfo_2_classLit = createForClass('java.util.logging', 'Level/LevelInfo', 120);
function Level$LevelOff(){
}

defineClass(121, 193, $intern_4, Level$LevelOff);
...
;
var Ljava_util_logging_Level$LevelOff_2_classLit = createForClass('java.util.logging', 'Level/LevelOff', 121);
function Level$LevelSevere(){
}

defineClass(122, 193, $intern_4, Level$LevelSevere);
...
;
var Ljava_util_logging_Level$LevelSevere_2_classLit = createForClass('java.util.logging', 'Level/LevelSevere', 122);
function Level$LevelWarning(){
}

defineClass(123, 193, $intern_4, Level$LevelWarning);
...
;
var Ljava_util_logging_Level$LevelWarning_2_classLit = createForClass('java.util.logging', 'Level/LevelWarning', 123);
...
defineClass(107, 1, {}, LogManager);
var singleton;
var Ljava_util_logging_LogManager_2_classLit = createForClass('java.util.logging', 'LogManager', 107);
...
defineClass(154, 1, $intern_4, LogRecord);
_.loggerName = '';
_.millis = {l:0, m:0, h:0};
_.thrown = null;
var Ljava_util_logging_LogRecord_2_classLit = createForClass('java.util.logging', 'LogRecord', 154);
...
// End GWT code
        ...
        var toReturn = {login: $wnd.login, formStart: $wnd.formStart, procStart: $wnd.procStart, changePassword: $wnd.changePassword, formStartEx: $wnd.formStartEx};   // LEOR - exporting
